...
class VectorSettingsGeneralFragment @Inject constructor(
    ...
    /*private val mIdentityServerPreference by lazy {
        findPreference<VectorPreference>(VectorPreferences.SETTINGS_IDENTITY_SERVER_PREFERENCE_KEY)!! //    сделал я
    }*/
...
//        mIdentityServerPreference.summary = session.identityService().getCurrentIdentityServerUrl() ?: getString(R.string.identity_server_not_defined) // сделал я
        refreshIntegrationManagerSettings()
